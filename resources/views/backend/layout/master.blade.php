...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="{{asset('asset/icon.png')}}" type="image/x-icon">
...
<body class="theme-indigo" style="background: white;">
    <!-- Page Loader -->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('dashboard')}}">SISTEM PILIHAN KEJURUAN</a>

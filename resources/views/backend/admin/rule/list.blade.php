...
<section class="content">
    ...
    <div class="container-fluid">
        <ol class="breadcrumb breadcrumb-bg-cyan">
            ...
            <li><a href="javascript:void(0);"><i class="material-icons">settings</i> Rule</a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-indigo" >
                            <h2>
                                 <i class="material-icons">settings</i> Data Rule <small>Halaman ini memuat data Rule yang telah tersimpan di dalam sistem.</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div>
                                <div class="demo-button-groups">
                                    <div class="btn-group " role="group">
                                        <a href="{{route('rule.create')}}" class="btn btn-primary waves-effect"><i class="material-icons">add</i> Tambah</a>
                                        <!--
                                    ...
                                    -->
                                        <a target="_blank" href="{{route('rule.print')}}" class="btn btn-success waves-effect"><i class="material-icons">print</i> Cetak</a>
                                    </div>       
                                </div>
                            </div>
                            <br>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align: center;">
               ...
               <p align="center">Anda ingin menghapus data Rule : <b>{{$kep->id}}</b> ?</p>

                <button type="button" style="color: white;" class="btn btn-link btn-warning waves-effect" data-dismiss="modal">BATAL</button>
                
                <a href="{{route('rule.destroy',$kep->id)}}" style="color: white;" class="btn btn-link btn-danger waves-effect">HAPUS</a>
...
<div class="modal fade" id="import" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <hr>
            <form action="{{route('rule.import')}}" method="POST" enctype="multipart/form-data">
            @csrf

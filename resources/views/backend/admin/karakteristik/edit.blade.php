            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header bg-indigo" >
                        <h2>
                             <i class="material-icons">edit</i> Edit Karakteristik : {{$cari->kode}} <small>Gunakan halaman ini untuk mengedit data karakteristik.</small>
                        </h2>
                    </div>
                    <div class="body">
                        <form action="{{route('karakteristik.update',$cari->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <label for="kode">Kode</label>
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('kode') ? 'focused error' : '' }}">
                                    <input type="text" value="{{ $cari->kode }}" id="kode" name="kode" class="form-control" placeholder="Kode Kepribadian">
                                </div>
                                @if ($errors->has('kode'))
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <select name="kepribadian_id" class="form-control">
                                        <option value="{{$cari->kepribadian_id}}">{{$cari->kepribadian->kepribadian}}</option>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="karakteristik" value="{{ $cari->karakteristik }}" name="karakteristik" class="form-control" placeholder="Karakteristik">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="pertanyaan" value="{{ $cari->pertanyaan }}" name="pertanyaan" class="form-control" placeholder="Pertanyaan">
                                </div>

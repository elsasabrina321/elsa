            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header bg-indigo" >
                        <h2>
                             <i class="material-icons">edit</i> Edit Kepribadian <small>Ubah data kepribadian : <b>{{$cari->kepribadian}}</b></small>
                        </h2>
                    </div>
                    <div class="body">
                        <form action="{{route('kepribadian.update',$cari->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf 
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" value="{{ $cari->kepribadian }}" id="kepribadian" name="kepribadian" class="form-control" placeholder="Kepribadian">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="deskripsi" value="{{ $cari->deskripsi }}" name="deskripsi" class="form-control" placeholder="Deskripsi Singkat">
                                </div>

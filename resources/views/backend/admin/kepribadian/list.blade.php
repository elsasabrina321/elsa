                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-indigo" >
                            <h2>
                                 <i class="material-icons">mood</i> Data Kepribadian <small>Halaman ini memuat data kepribadian yang telah tersimpan di dalam sistem.</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div>
                                <div class="demo-button-groups">
                                    <div class="btn-group " role="group">
                                        <a href="{{route('kepribadian.create')}}" class="btn btn-primary waves-effect"><i class="material-icons">add</i> Tambah</a>
                                        ...
                                        <a target="_blank" href="{{route('kepribadian.print')}}" class="btn btn-success waves-effect"><i class="material-icons">print</i> Cetak</a>
                                    </div>       
                                </div>
                            </div>
                            <br>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$kep->deskripsi}}</td>
                                            <td>
                                                <a href="{{route('kepribadian.edit',$kep->id)}}" class="btn bg-lime btn-circle waves-effect waves-circle waves-float">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align: center;">
               ...
               <p align="center">Anda ingin menghapus data kepribadian : <b>{{$kep->kepribadian}}</b> ?</p>

                <button type="button" style="color: white;" class="btn btn-link btn-warning waves-effect" data-dismiss="modal">BATAL</button>
                
                <a href="{{route('kepribadian.destroy',$kep->id)}}" style="color: white;" class="btn btn-link btn-danger waves-effect">HAPUS</a>
...
<div class="modal fade" id="import" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <hr>
            <form action="{{route('kepribadian.import')}}" method="POST" enctype="multipart/form-data">
            @csrf
